...
class CreateFolderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'parent_folder_id.required' => __('The parent folder ID is required.'),
            'parent_folder_id.string' => __('The parent folder ID must be a string.'),
            'parent_folder_id.min' => __('The parent folder ID must contain at least 1 character.'),
            'parent_folder_id.max' => __('The parent folder ID cannot exceed 50 characters.'),
