...
class GenerateAsyncRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prefix_audio_url' => ['nullable', 'url'],
            'suffix_text' => ['nullable', 'string'],
            'suffix_audio_url' => ['nullable', 'url'],
    ...
    public function messages(): array
    {
        return [
            ...
            'prefix_audio_url.url' => __('The prefix audio URL must be a valid URL.'),
            'suffix_text.string' => __('The suffix text must be a string.'),
            'suffix_audio_url.url' => __('The suffix audio URL must be a valid URL.'),
