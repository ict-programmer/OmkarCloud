...
class ImageSearchEditorialRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'fields.editorial_segments'          => 'nullable|boolean',
            ...
            'fields.minimum_quality_rank' => 'nullable|integer|in:1,2,3',
            'fields.facet_fields'        => 'nullable|array',
            'fields.facet_fields.*'      => 'string|in:artists,events,locations, specific_people',
