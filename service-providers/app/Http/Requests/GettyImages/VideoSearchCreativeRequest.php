...
class VideoSearchCreativeRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'fields.license_models'                    => 'nullable|array',
            'fields.license_models.*'                  => 'string|rightsready,royaltyfree',
            ...
            'fields.release_status'      => 'nullable|string|in:release_not_important,full_eleased',
