...
class GoogleController extends BaseController
{
    ...
    #[OA\QueryParameter(name: 'c2coff', description: 'Turns country restriction off or on', required: false, schema: new OA\Schema(type: 'string', enum: ['0', '1'], nullable: true))]
    ...
    #[OA\QueryParameter(name: 'dateRestrict', description: 'Restricts search results to a date range (e.g., "d[number]" for days)', required: false, schema: new OA\Schema(type: 'string', nullable: true))]
    ...
    #[OA\QueryParameter(name: 'googlehost', description: 'Google domain to use for the search', required: false, schema: new OA\Schema(type: 'string', nullable: true))]
    ...
    #[OA\QueryParameter(name: 'lr', description: 'Restricts by language', required: false, schema: new OA\Schema(type: 'string', nullable: true))]
    ...
    #[OA\QueryParameter(name: 'rights', description: 'Usage rights filter', required: false, schema: new OA\Schema(type: 'string', nullable: true))]
    #[OA\QueryParameter(name: 'safe', description: 'SafeSearch setting', required: false, schema: new OA\Schema(type: 'string', enum: ['off', 'medium', 'active'], nullable: true))]
    ...
    #[OA\QueryParameter(name: 'sort', description: 'Sort results', required: false, schema: new OA\Schema(type: 'string', nullable: true))]
    ...
    #[OA\QueryParameter(name: 'hq', description: 'Additional search terms to append', required: false, schema: new OA\Schema(type: 'string', nullable: true))]
    #[OA\QueryParameter(name: 'imgColorType', description: 'Restricts to images of a certain color type', required: false, schema: new OA\Schema(type: 'string', enum: ['color', 'gray', 'mono'], nullable: true))]
    ...
    #[OA\QueryParameter(name: 'imgSize', description: 'Restricts results to a specific image size', required: false, schema: new OA\Schema(type: 'string', enum: ['small', 'medium', 'large', 'xlarge'], nullable: true))]
