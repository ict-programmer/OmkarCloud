...
trait QwenTrait
{
    ...
    /**
     * Prepare an attachment for Qwen AI
     * 
        ...
        try {
            switch ($type) {
                ...
                default:
                    ...
                    throw new BadRequestHttpException("Unsupported file type '{$mimeType}' for Qwen AI: {$fileName}");
            }
        } catch (Exception $e) {
            ...
            Log::error("Error processing attachment for Qwen AI: " . $e->getMessage(), [
                'file' => $fileName,
                'mime_type' => $mimeType,
                'exception' => $e
            ]);
    ...
    private static function handleTextFile(UploadedFile $file, string $fileName, string $mimeType): array
    {
        ...
        // Return in the format qwen expects
        return [
            'type' => 'text',
    ...
    private static function handleSpreadsheetFile(UploadedFile $file, string $fileName): array
    {
        ...
        throw new BadRequestHttpException("Excel files like '{$fileName}' are not directly supported by Qwen AI. Consider converting to CSV format.");
    }
